...
Cubre el paso 2 del alta — completar el perfil de un usuario ya autenticado (nombre, alias único,
foto y exactamente 5 cualidades personales) como wizard de 2 pasos — y la regla transversal de que,
sin ese perfil, ninguna otra pantalla de la aplicación es accesible.
