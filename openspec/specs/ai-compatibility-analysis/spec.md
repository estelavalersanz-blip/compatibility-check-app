...
(Groq como proveedor principal, OpenRouter como alternativa intercambiable): muestrea 6 preguntas por
comparación (1 al azar de cada uno de los 6 bloques del cuestionario, no las 36 completas) y las
analiza en una única llamada, valida la salida del modelo contra el esquema esperado con reintentos
ante fallos, calcula el resultado agregado con ponderación compuesta (bloques de preguntas anidados en
pesos por dimensión), y registra el flujo completo con logging estructurado sin exponer nunca el
contenido de las respuestas de los usuarios.
